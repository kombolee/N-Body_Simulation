...
print(timeit.timeit('initialize()', number=3, globals=globals()))
print(timeit.timeit('compute_force()', number=3, globals=globals()))
print(timeit.timeit('update()', number=3, globals=globals()))
